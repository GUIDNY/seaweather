const CACHE = 'ww-v18';
const ASSETS = ['./', './index.html', './styles.css?v=14', './app.js?v=17', './manifest.json', './logo.svg', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './favicon-32.png', './fox-surf.png', './fox-wind.png', './fox.png'];
